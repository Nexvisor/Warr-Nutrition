...
import { FileWithPreview } from "./AddProductSection";
...
export default function ImageUpload({ files, setFiles }: ImageUploadType) {
      ...
      >
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="space-y-2">
            <h3 className="text-xl md:text-2xl font-semibold bg-gradient-to-br from-[#1e7ae4] to-[#052f5e] bg-clip-text text-transparent">
              {isDragging
                ? "Drop files here"
                : files.length
                ? "Add more files"
            ...
            <p className="text-zinc-600 dark:text-zinc-300 md:text-lg max-w-md mx-auto">
              {isDragging ? (
                <span className="font-medium bg-gradient-to-br from-[#1e7ae4] to-[#052f5e] bg-clip-text text-transparent">
                  Release to upload
                </span>
              ) : (
                <>
